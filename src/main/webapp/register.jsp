	...
	<div class="bd">
		<div class="bdW textWarp w1190">
			<div class="bdArea clearfix">
				<form action="${pageContext.request.contextPath}/userregister.do" name="userregisterform"  method="post">
					<div class="bdATxt W313">
						...
						<!-- 手机号码 -->
						<p class="clearfix">
							<input class="W313" type="text" name="username" placeholder="请输入用户名">
						</p>
						<!-- 密码 -->
						<p class="clearfix">
						...
						<p class="clearfix Pbtn">
							<a class="W313" href="javascript:document.userregisterform.submit()">注册</a>
						</p>
						<!-- 用户协议 -->
